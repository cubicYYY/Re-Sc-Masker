...
TrivialMaskedRegion::replaceInstruction(const Instruction &inst) {
  ...
  // need optimization!
  if (op == "|" || op == "||") {
    ValueInfo nA(assignTo.name + "ornA", VType::Bool, VProp::UNK, nullptr);
    ValueInfo nB(assignTo.name + "ornB", VType::Bool, VProp::UNK, nullptr);
    ValueInfo andNN(assignTo.name + "orand", VType::Bool, VProp::MASKED,
                    nullptr);
    ...
    ValueInfo mA(assignTo.name + "xormA", VType::Bool, VProp::MASKED, nullptr);
    ValueInfo mB(assignTo.name + "xormB", VType::Bool, VProp::MASKED, nullptr);
    ValueInfo mR(assignTo.name + "xormR", VType::Bool, VProp::MASKED, nullptr);
    ValueInfo mT(assignTo.name + "xormT", VType::Bool, VProp::MASKED, nullptr);
    ...
    ValueInfo r1 = ValueInfo::getNewRand();
    ValueInfo mA(assignTo.name + "notmA", VType::Bool, VProp::MASKED, nullptr);
    ValueInfo mT(assignTo.name + "notmT", VType::Bool, VProp::MASKED, nullptr);
    ...
    ValueInfo mA(assignTo.name + "andmA", VType::Bool, VProp::MASKED, nullptr);
    ValueInfo mB(assignTo.name + "andmB", VType::Bool, VProp::MASKED, nullptr);
    ValueInfo negmB(assignTo.name + "andneg1", VType::Bool, VProp::UNK,
                    nullptr);
    ValueInfo mAr2(assignTo.name + "andr2", VType::Bool, VProp::UNK, nullptr);
    ValueInfo negr3(assignTo.name + "andneg2", r3.type, VProp::UNK, nullptr);
    ValueInfo tmp1(assignTo.name + "andtmp1", VType::Bool, VProp::UNK, nullptr);
    ValueInfo tmp2(assignTo.name + "andtmp2", VType::Bool, VProp::UNK, nullptr);
    ValueInfo tmp3(assignTo.name + "andtmp3", VType::Bool, VProp::UNK, nullptr);
    ValueInfo tmp4(assignTo.name + "andtmp4", VType::Bool, VProp::UNK, nullptr);
    ValueInfo tmp5(assignTo.name + "andtmp5", VType::Bool, VProp::UNK, nullptr);
    ValueInfo tmp6(assignTo.name + "andtmp6", VType::Bool, VProp::UNK, nullptr);
