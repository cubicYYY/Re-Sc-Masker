...
Z3VInfo BitBlastPass::traverseZ3Model(const z3::expr &e, int depth) {
    ...
    if (e.is_var()) {
        ...
        region.instructions.emplace_back(Instruction{width == 1 ? "!" : "~", new_var,
        ...
        if (name == "if") {
            ...
            region.instructions.emplace_back(Instruction{"&", then_expr,
                                                         ValueInfo{then_z3.name, width, VProp::UNK, nullptr},
                                                         ValueInfo{cond_z3.name, 1, VProp::UNK, nullptr}});
            region.instructions.emplace_back(Instruction{"&", else_expr,
